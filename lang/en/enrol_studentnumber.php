...
$string['studentnumbers'] = 'Student index numbers (or CSV contents from Zapisy)';
$string['studentnumbers_help'] = '<p>Paste here student index numbers (one per line), or complete CSV file exported from Zapisy.</p>';
